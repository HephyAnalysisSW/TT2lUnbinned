...
TTLep_Summer16_preVFP           = Sample.fromDirectory(name="TTLep_Summer16_preVFP", treeName="Events", isData=False, color=color.TT, texName="t#bar{t}", directory=make_dirs( ['TTLep_pow_CP5'] ))
