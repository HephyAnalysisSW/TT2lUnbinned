...
cmsenv
git clone --branch sigmaJEC --single-branch https://github.com/HephyAnalysisSW/nanoAOD-tools.git PhysicsTools/NanoAODTools
git clone git@github.com:HephyAnalysisSW/TT2lUnbinned.git
git clone git@github.com:HephyAnalysisSW/tttt
