...
for var in [
    ...
    "year", "overflow_counter_v1", "overflow_counter_v2", #"overflow_counter_v3", 
...
training_samples = [
    samples.TTLep,
    Summer16_preVFP.TTLep_Summer16_preVFP,
    Summer16.TTLep_Summer16,
    Fall17.TTLep_Fall17,
    Autumn18.TTLep_Autumn18,
    #samples.TTLep_pow_hUp,
    #samples.TTLep_pow_hDown,
